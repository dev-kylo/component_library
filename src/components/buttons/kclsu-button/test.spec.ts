    ...
    it('when given small prop it should render HTML with the small class added', async () => {
        ...
        expect(page.root.shadowRoot).toEqualHtml(`
            <flex-container alignx="flex-start">
                <a role="button" class="green small" href="/page" target="_self" rel="" style="margin: 15px;">
                    <slot></slot>
                </a>
            </flex-container>
        `)
    ...
    it('when given newtab and purple props it should render "a" tag with purple class, and new tab target', async () => {
        ...
        expect(page.root).toEqualHtml(`
            <kclsu-button link="/page" purple="" newtab="">
                <mock:shadow-root>
                    <flex-container alignx="flex-start">
                        <a role="button" rel="noopener noreferrer" class="purple big" href="/page" target="_blank" style="margin: 15px;">
                            <slot></slot>
                        </a>
                     </flex-container>
                </mock:shadow-root>

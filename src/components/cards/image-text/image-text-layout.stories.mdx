...
<Meta
  title="Layouts/Image next to Text"
...
```html
<image-text heading="Card Heading" image="/image.jpg">
...
## Advanced 
Here are some more advanced options if you need more control over how the component renders.

Also look at the full list of controls/attributes in the list at the bottom.
